...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    isTablet ? 320 : isSmallPhone ? size.height * 0.26 : size.height * 0.32;
    final double cardHeight = isTablet ? 340 : isSmallPhone ? 280 : 320;
                                ...
                                ClipRRect(
                                  ...
                                  child: BackdropFilter(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: const Color(0xff050B1E).withOpacity(0.3),
                                        borderRadius: BorderRadius.circular(24),
                                        border: Border.all(
